    ...
    <div className="w-full bg-white min-h-screen">
      ...
      <div className="bg-indigo-600 text-white p-6 md:p-16">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="opacity-80">Manage and track all tickets purchased by you.</p>
   ...
   useEffect(() => {
     const fetchEvents = async () => {
       ...
       try {
         ...
         const res = await fetch(`http://localhost:8000/api/transactions/${organizerAddress}/tickets`);
     ...
     return (
          <div className="mb-10 bg-indigo-50 min-h-screen w-full p-6 text-black">
               <h2 className="text-2xl font-bold text-indigo-800 mb-6">Tickets for user {userData?.id || ""}</h2>
               {tickets.length === 0 ? (
